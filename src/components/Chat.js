...
function Chat() {
  ...
  return (
    <div className="bg-sky-500 w-screen h-screen grid grid-rows-6">
        ...
        <div className="flex">
          <div className="relative">
            ...
            <svg
              ...
              fill="currentColor"
              aria-hidden="true"
              className="h-4 w-4 text-green-400 absolute bottom-0 right-4 shadow-lg"
            >
      ...
      <div className="row-span-5 bg-white rounded-t-xl relative grid grid-rows-6 h-full px-3 pb-3">
